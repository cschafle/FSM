...
import com.example.user.fsm.Flickr.tasks.GetOAuthTokenTask;
import com.example.user.fsm.Flickr.tasks.OAuthTask;
import com.example.user.fsm.Flickr.tasks.UploadPhotoTask;
